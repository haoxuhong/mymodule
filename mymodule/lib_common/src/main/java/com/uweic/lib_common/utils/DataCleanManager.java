...
/**
 * Created by haoxuhong on 2019/9/24.
 *
 * @description: 本应用数据清除管理器
 * 主要功能:清除内缓存，清除外部cache下的内容 清除本应用所有数据库，按名字清除本应用数据库 清除sharedPreference，清除files和清除自定义目录
 * 清除/data/data/com.xxx.xxx/files下的内容   清除本应用所有的数据
