package com.uweic.lib_dialog.widget;
...
/**
 * Created by haoxuhong on 2019/10.10.
 *
...
public final class SettingBar extends FrameLayout {
    ...
    public SettingBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (getBackground() == null) {
            Drawable drawable = ContextCompat.getDrawable(getContext(), R.drawable.widget_bg_setting_bar_selector);
